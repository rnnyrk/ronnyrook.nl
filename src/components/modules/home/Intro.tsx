  ...
  return (
    <article>
      ...
      <p className="mt-10 mb-4 text-lg">
        Hey, I'm Ronny. An {getAge()} year old <strong>Javascript developer</strong> from Amsterdam,
        The Netherlands.
      </p>
      ...
      <p className="mb-4 text-lg">
        I love building for the web. From simple pages, to native applications, all the way to large
        Next.js applications. <strong>The web and Javascript are incredible</strong>. It gives
        everyone the freedom to just start creating.
      </p>
